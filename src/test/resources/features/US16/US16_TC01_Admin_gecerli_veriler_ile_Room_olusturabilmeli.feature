...
And Room number kutusuna veri gir
And Price kutusuna veri gir
And Description kutusuna veri gir
And Created date kutusuna veri gir
And Room save butonuna tikla
And Room create islemini dogrula
And Rooms listesindeki son sayfaya tikla
And Room numberin listede oldugunu dogrula